...
class MakeSheetModelCommandTest extends TestCase
{
    ...
    public function it_creates_a_sheet_model_without_committing_any_crimes()
    {
        $this->artisan('make:sheet-model')
            ...
            ->expectsQuestion('Copy and paste the full URL of your Google Sheet from your browser address bar:', 'https://docs.google.com/spreadsheets/d/1dEQg2Z1kgqUy3db3FOjeLAVVMGEX7MF-_rFtQQ6UxG8/edit#gid=688412530')
